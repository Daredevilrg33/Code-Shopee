...
public class AdminCatList extends Activity implements AnimationListener,
		OnItemClickListener {
	...
	String userid, selectedtab = "category", catid, tempcategory, newcatimage,
			newsubcatimage;
	Globals globals;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(AdminCatList.this, AdminPage.class));
				finish();
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (globals.getchange().equals("offers")) {
					...
					catid = globals.getCategoryList().get(position).get("id");
					dialog = new Dialog(AdminCatList.this);
						...
						public void onClick(View v) {
							...
							new Handler().postDelayed(new Runnable() {
								...
								public void run() {
									...
									new Thread(null, Adddeal, "refresh_data")
											.start();
								}
							}, 0);
				...
				} else if (globals.getchange().equals("edit")) {
					...
					Picasso.with(AdminCatList.this)
					...
					TextView selectcategoryname = (TextView) dialog
							.findViewById(R.id.selectcategoryname);

					selectcategoryname.setVisibility(0);
					selectcategoryname.setText(globals.getCategoryList()
							.get(position).get("category"));
					tempimage = (CircularImageView) dialog
							.findViewById(R.id.newimage);
					final EditText newname = (EditText) dialog
							.findViewById(R.id.newname);
					Button change = (Button) dialog.findViewById(R.id.change);
					change.setText("Add Sub Category");
					tempimage.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							new Handler().postDelayed(new Runnable() {
								...
								public void run() {
									...
									new Thread(null, AddnewSubcategory,
											"refresh_data").start();
								}
							}, 0);
						...
						public void onClick(View v) {
							...
							new Handler().postDelayed(new Runnable() {
								...
								public void run() {
									...
									new Thread(null, Deletecategory,
											"refresh_data").start();
								}
							}, 0);
				...
				// TODO Auto-generated method stub
				// Intent product = new Intent(AdminCatList.this,
				// Product.class);
				// product.putExtra("catid",
				// categories.get(position).get("id"));
	...
	Runnable Deletecategory = new Runnable() {
		...
		public void run() {
			...
			try {
				...
				result = WebServiceHandler.deletecategory(
						getApplicationContext(), catid);
	...
	Runnable AddnewSubcategory = new Runnable() {
		...
		public void run() {
			...
			try {
				...
				result = WebServiceHandler.addnewsubcategory(
						getApplicationContext(), catid, tempcategory,
						newcatimage);
			...
			Message msg = new Message();
			msg.obj = result;
			AddnewSubcategoryHandler.sendMessage(msg);

		}
	};

	Handler AddnewSubcategoryHandler = new Handler() {
		...
		public void run() {
			...
			try {
				...
				result = WebServiceHandler.addnewdeal(getApplicationContext(),
						catid, tempcategory, newcatimage, "category");
	...
	public class SubAdapterList extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			namesubcact.setText(customsubcat.get(position).get("catgeory"));
